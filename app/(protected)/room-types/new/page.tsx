...
export default function NewRoomTypePage() {
  ...
  return (
    <div className="max-w-lg">
      ...
      <h2 className="text-2xl font-bold text-slate-900 mb-1">Add Room Type</h2>
      <p className="text-slate-500 text-sm mb-6">Define a new category of rooms with its amenities and pricing.</p>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-5">
        <div>
          ...
          <input
            ...
            placeholder="e.g. Single AC, Double Non-AC, Dormitory"
            required
